...
#align(center)[
  #grid(
    ...
    [#text(13.5pt, font: "Inter 28pt", weight: "bold")[#abbr.s("HAW Kiel")] \ #text(12pt)[#abbr.lo("HAW Kiel")]], [#text(14pt, font: "Inter 28pt", weight: "bold")[#abbr.lo("Dataport")]]
  )
  #v(1fr)
  #text(size: 24.33pt, font: "Inter 28pt", weight: "bold")[#about.title] \
  #v(1.618em)
